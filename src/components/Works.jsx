  ...
  return (
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          Below are the projects I've handled and some side projects I've
          written to test my own abilities. I enjoy having a conversation with
          myself using code during the quiet hours of the night. I enjoy
